...
import {  Container,  QuotationTitle,  QuotationDesc, QuotationFilterBox,
         QuotationByWeek, QuotationByWeekText , QuotationByWeekSelectButton
          } from './styles';
...
// ARRUMAR FUNCOES DO INPUT
  ...
  return (
   <Container>
    <QuotationTitle>
    <h1>Cotação ThunderCoin</h1></QuotationTitle>

    <QuotationFilterBox>

        <QuotationByWeek>
          <QuotationByWeekText><h1>Data Inicial:</h1></QuotationByWeekText>
          <QuotationByWeekSelectButton>
            <input type="date" onChange={handleStartDate} />
          </QuotationByWeekSelectButton>
          <QuotationByWeekText><h1>Data Final:</h1></QuotationByWeekText>
          <QuotationByWeekSelectButton>
    ...
    <div className="QuotationGraph">
      <Chart
       options={{legendTextStyle: { color: '#FFF' },
                 ...
                 colors: ['#640096'], backgroundColor: '#FE7600'}
                }
       chartType="AreaChart"
       width="100vh"
       height="50vh"
